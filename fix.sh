...
sudo -u sentinelweb git stash 2>/dev/null || true
# Resetar para o estado remoto
sudo -u sentinelweb git fetch origin
sudo -u sentinelweb git reset --hard origin/main
